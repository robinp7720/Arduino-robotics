...
class XboxController(threading.Thread):
    ...
    def _sortOutTriggerValue(self, value):
        # trigger goes -1 to 1 (-1 is off, 1 is full on, half is 0) - I want
        # this to be 0 - 1
...
if __name__ == '__main__':
    ...
    # setup xbox controller, set out the deadzone and scale, also invert the Y
    # Axis (for some reason in Pygame negative is up - wierd!
